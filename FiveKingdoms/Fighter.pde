class Fighter implements FighterActions {
  ...
  Fighter (String name, int health, PVector movSpeed, PVector position, PVector size, PImage aspect) {
    this.name = name;
    this.health = health;
  ...
  Fighter(String name, int health, PVector movSpeed, PVector position, PVector size, PImage aspect, boolean location){
    this(name, health, movSpeed, position, size, aspect);
