...
public PImage mouse, title, mainMenuBack, start, start2, instrucciones, instrucciones2, instruccionesFondo, creditos, creditos2, retroceder, retroceder2, krisAspect, krisAspectRight, krisBasicDaga, krisBasicDagaRight, name_kris, shield_Kris,fire_wave_kris_p2,fire_wave_kris,vs;
...
public class Data {
  public Data() {    
    ...
    instruccionesFondo = loadImage("data/fondo_instrucciones.jpeg");
    ...
    mainMenuButtons.add(new Button("", 20, 65, height-35, 75, 50, retroceder, retroceder2));
